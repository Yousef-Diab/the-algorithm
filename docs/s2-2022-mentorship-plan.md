...
**Status: complete.** All 16 batches in §7 are done — 40 lessons, a section summary and a
...
| 2 | p1 | 4–6 | `p1-04`–`p1-06` | 93 KB | [x] |
| 3 | p1 | 7 | `p1-07` | 60 KB | [x] |
| 4 | p2 | 8–10 | `p2-01`–`p2-03` | 106 KB | [x] |
| 5 | p2 | 11–12 | `p2-04`–`p2-05` | 99 KB | [x] |
| 6 | p2 | 13 | `p2-06` | 44 KB | [x] |
| 7 | p3 | 14–17 | `p3-01`–`p3-04` | 90 KB | [x] |
| 8 | p3 | 18 | `p3-05` | 63 KB | [x] |
| 9 | p3 | 19 | `p3-06` | 131 KB | [x] |
| 10 | p4 | 20–22 | `p4-01`–`p4-03` | 106 KB | [x] |
...
| P | — | — | Polish: part titles, `summary.html`, `exam.js`, home copy | — | [x] |

**Polish session (P)** — done. **Section 2 is complete: 40 lessons, a section summary and a
40-question final exam.** What it covered:
- Confirmed/rewrote the six part titles and descriptions in `months.js` from the real content.
- Wrote `content/s2-2022-mentorship/summary.html` (`id="s2-review"`, `data-kind="review"`,
  `.review-footer` slot) — it re-states the lessons, it adds nothing.
- Wrote `content/s2-2022-mentorship/exam.js` — 40 questions across the six parts; the exam
  page itself is generated by `build.py`.
- Updated the home hero copy in `engine/home.html` and the README to describe both sections.
...
- ~~**Part titles.**~~ Confirmed in the polish session and written into `months.js`; the §3
  table's themes remain the shorthand used when planning the batches.

Nothing is still open — **Section 2 is finished**.
